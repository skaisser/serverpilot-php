...
class ServerPilot
{
    ...
    {
        if (empty($config)) {
            throw new Exception(self::SP_MISSING_CONFIG);
        }
        if (!isset($config['id']) || !isset($config['key'])) {
            throw new Exception(self::SP_MISSING_API);
        }
    ...
    public function server_create($name)
    {
        ...
        return $this->_send_request('servers', $params, self::SP_HTTP_METHOD_POST);
    }
    ...
    {
        return $this->_send_request("servers/$id", array(), self::SP_HTTP_METHOD_DELETE);
    }
    ...
    public function server_update($id, $firewall = null, $autoupdates = null)
    {
        ...
        return $this->_send_request("servers/$id", $params, self::SP_HTTP_METHOD_POST);
    }
    ...
    public function sysuser_create($id, $name, $password = null)
    {
        ...
        return $this->_send_request('sysusers', $params, self::SP_HTTP_METHOD_POST);
    }
    ...
    {
        return $this->_send_request("sysusers/$id", array(), self::SP_HTTP_METHOD_DELETE);
    }
    ...
    public function sysuser_update($id, $password)
    {
        ...
        return $this->_send_request("sysusers/$id", $params, self::SP_HTTP_METHOD_POST);
    }
     ...
     * @param string $sysuserid The serverpilot user id
     * @param string $runtime   The php runtime
     * @param array  $domains   Array containing all the domain requested.
     * @param array  $wordpress Wordpress information if desired to install wordpress automaticly
     */
    public function app_create($name, $sysuserid, $runtime, $domains = array(), $wordpress = array())
    {
        ...
        if ($wordpress) {
            $params['wordpress'] = json_decode(json_encode($wordpress), false);
        }
    ...
    {
        return $this->_send_request("apps/$id", array(), self::SP_HTTP_METHOD_DELETE);
    }
    ...
    public function app_update($id, $runtime = null, $domains = null)
    {
        ...
        return $this->_send_request("apps/$id", $params, self::SP_HTTP_METHOD_POST);
    }
    ...
    public function ssl_add($id, $key, $cert, $cacerts = null)
    {
        ...
        return $this->_send_request("apps/$id/ssl", $params, self::SP_HTTP_METHOD_POST);
    }
    ...
    {
        return $this->_send_request("apps/$id/ssl", array(), self::SP_HTTP_METHOD_DELETE);
    }
    ...
    public function database_create($id, $name, $username, $password)
    {
        ...
        return $this->_send_request('dbs', $params, self::SP_HTTP_METHOD_POST);
    }
    ...
    {
        return $this->_send_request("dbs/$id", array(), self::SP_HTTP_METHOD_DELETE);
    }
    ...
    public function database_update($id, $userid, $password)
    {
        ...
        return $this->_send_request("dbs/$id", $params, self::SP_HTTP_METHOD_POST);
    }
    ...
    private function _send_request($url_segs, $params = array(), $http_method = 'get')
    {
        ...
        $req = curl_init(self::SP_API_ENDPOINT.$url_segs);

        curl_setopt($req, CURLOPT_USERAGENT, self::SP_USERAGENT);
        ...
        if ($http_method == self::SP_HTTP_METHOD_POST) {
        ...
        if ($http_method == self::SP_HTTP_METHOD_DELETE) {
